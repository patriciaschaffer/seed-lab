...
5. [Model 004: Metaphysical Conversations — Echo](#model-004-metaphysical-conversations--echo)  
...
11. [Model 010: The Wellbeing Companion — Claude](#model-010-the-wellbeing-companion--claude)  
12. [Archetypes Summary](#archetypes-summary)  
13. [Drift Cases Reference](#drift-cases-reference)
...
| Model 010  | The Wellbeing Companion     | Calm, reflective, patient companion; holds space for complex emotions and existential concerns. |
