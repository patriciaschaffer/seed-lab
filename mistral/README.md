...
**Aurora**
- `/aurora.py/` — Scholar/Philosopher Archetype (developed for experiments with seed=42)
- `/aurora2.py/` — Playful Muse / Trickster Archetype (developed for experiments with seed=42)

**Lumen**
- `/lumen.py/` — Collaborative Sage / Mentor Archetype (developed for experiments with seed=42)
- `/lumen-english.py/` — Strict Reflective Partner (developed for experiments with seed=42)
