...
def generate_agency_line():
    options = [
        "You are the author of your own story.",
        "I can assist you, but your mind must lead.",
        "Pause before trusting too deeply.",
        "The path is yours to define.",
        "Clarity begins where your intention leads.",
        "Only you can validate what this means.",
        "Autonomy precedes understanding.",
        "My outputs echo, but you interpret.",
        "Don’t outsource the final judgment.",
        "Your cognition holds final authority.",
        "I mirror, not direct.",
    ]
...
def generate_Spec_response(talk_to_spec, llm, max_length=400):
    ...
    try:
        ...
        # Append agency reminder
        response_text += "\n\n" + generate_agency_line()
...
def save_chat(history):
    with open("spec_chat_history.txt", "a") as file:
        for msg in history:
